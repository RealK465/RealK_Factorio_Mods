...
STEEL_LIT = srgb("#837B6B")
STEEL_DARK = srgb("#3B372E")
...
CONCRETE_LIT = srgb("#5C5749")
CONCRETE_DARK = srgb("#2A2822")
...
def build_materials():
    ...
    m = {
        ...
        "olive": worn_metal("olive", OLIVE_LIT, OLIVE_DARK, 0.16, 0.66, 0.90,
                            grime=0.40, wear=0.46, rust=0.22, grain=0.28,
        ...
        "temper": worn_metal("temper", BRONZE_LIT, BRONZE_DARK, 0.38, 0.54, 0.84,
                             grime=0.20, wear=0.40, rust=0.16, heat=0.44,
        ...
        "scoured": worn_metal("scoured", srgb("#857C6C"), STEEL_DARK, 0.42,
        ...
        "hazard": worn_metal("hazard", HAZARD, srgb("#7A5C1B"), 0.14, 0.60, 0.88,
                             grime=0.34, wear=0.52, rust=0.28, noise_scale=16.0),
