...
- **Only a mod's own source may differ between the two branches.** `CLAUDE.md`, `README.md`,
  ...
  effect values are ten times larger on 2.0** (`quality = 1.25` there for the 12.5% that `0.125`
